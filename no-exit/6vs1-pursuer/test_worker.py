...
class TestWorker:
    def __init__(self, meta_agent_id, policy_net, global_step, device='cuda', greedy=False, save_image=False, random_seed=None):
        ...
        if self.env.input_type == 'map':
            self.robot_positions = self.env.start_robot_positions
    ...
    def run_episode_DP(self, curr_episode):
        if self.env.input_type == 'map':
            ...
            for i in range(128):
                previous_index = copy.deepcopy(self.env.robot_indexes)
                next_node_0 = self.env.reference_policy[0, int(self.env.target_index), int(self.env.robot_indexes[0]), int(self.env.robot_indexes[1])]
                next_node_1 = self.env.reference_policy[1, int(self.env.target_index), int(self.env.robot_indexes[0]), int(self.env.robot_indexes[1])]
                next_node_2 = self.env.reference_policy[0, int(self.env.target_index), int(self.env.robot_indexes[2]), int(self.env.robot_indexes[3])]
                next_node_3 = self.env.reference_policy[1, int(self.env.target_index), int(self.env.robot_indexes[2]), int(self.env.robot_indexes[3])]
                next_node_4 = self.env.reference_policy[0, int(self.env.target_index), int(self.env.robot_indexes[4]), int(self.env.robot_indexes[5])]
                next_node_5 = self.env.reference_policy[1, int(self.env.target_index), int(self.env.robot_indexes[4]), int(self.env.robot_indexes[5])]
                
                self.env.robot_indexes[0] = next_node_0
                self.env.robot_indexes[1] = next_node_1
                self.env.robot_indexes[2] = next_node_2
                self.env.robot_indexes[3] = next_node_3
                self.env.robot_indexes[4] = next_node_4
                self.env.robot_indexes[5] = next_node_5
    ...
    def select_node_DP(self, observations):
        ...
        next_node_1 = self.env.reference_policy[0, int(self.env.target_index), int(self.env.robot_indexes[0]), int(self.env.robot_indexes[1])]
        next_node_2 = self.env.reference_policy[1, int(self.env.target_index), int(self.env.robot_indexes[0]), int(self.env.robot_indexes[1])]
        next_node_3 = self.env.reference_policy[0, int(self.env.target_index), int(self.env.robot_indexes[2]), int(self.env.robot_indexes[3])]
        next_node_4 = self.env.reference_policy[1, int(self.env.target_index), int(self.env.robot_indexes[2]), int(self.env.robot_indexes[3])]
        next_node_5 = self.env.reference_policy[0, int(self.env.target_index), int(self.env.robot_indexes[4]), int(self.env.robot_indexes[5])]
        next_node_6 = self.env.reference_policy[1, int(self.env.target_index), int(self.env.robot_indexes[4]), int(self.env.robot_indexes[5])]

        rp = [self.env.node_coords[next_node_1], self.env.node_coords[next_node_2], self.env.node_coords[next_node_3], \
            self.env.node_coords[next_node_4], self.env.node_coords[next_node_5], self.env.node_coords[next_node_6]]
