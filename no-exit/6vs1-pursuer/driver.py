        ...
        while True:
            ...
            if curr_episode % 1 == 0 and len(experience_buffer[0]) >= MINIMUM_BUFFER_SIZE:
                ...
                for j in range(8):
                    ...
                    reference_policy_batch = reference_policy_batch.to(torch.int64)
                    ...
                    logp = result.permute(0, 6, 5, 4, 3, 2, 1).reshape(BATCH_SIZE, K_SIZE**N_ROBOTS, -1)  # (batch_size, K_SIZE**N_ROBOTS, 1)
