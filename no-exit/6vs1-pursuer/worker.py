...
class Worker:
    ...
    def select_node(self, robot_index, observations, edge_for_select_node):
        ...
        if robot_index == 0:
            next_node = self.env.reference_policy[0, int(self.env.target_index), int(self.env.robot_indexes[0]), int(self.env.robot_indexes[1])]
        elif robot_index == 1:
            next_node = self.env.reference_policy[1, int(self.env.target_index), int(self.env.robot_indexes[0]), int(self.env.robot_indexes[1])]
        elif robot_index == 2:
            next_node = self.env.reference_policy[0, int(self.env.target_index), int(self.env.robot_indexes[2]), int(self.env.robot_indexes[3])]
        elif robot_index == 3:
            next_node = self.env.reference_policy[1, int(self.env.target_index), int(self.env.robot_indexes[2]), int(self.env.robot_indexes[3])]
        elif robot_index == 4:
            next_node = self.env.reference_policy[0, int(self.env.target_index), int(self.env.robot_indexes[4]), int(self.env.robot_indexes[5])]
        elif robot_index == 5: 
            next_node = self.env.reference_policy[1, int(self.env.target_index), int(self.env.robot_indexes[4]), int(self.env.robot_indexes[5])]
