...
def run_test():
    ...
    try:
        ...
        print('|#Average Step:', np.array(step_history).mean())
...
class Runner(object):
    ...
    def do_job(self, episode_number):
        worker = TestWorker(self.meta_agent_id, self.local_network, episode_number, device=self.device, save_image=SAVE_GIFS, greedy=False, random_seed=RANDOM_SEED)
