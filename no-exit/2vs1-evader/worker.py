...
class Worker:
    ...
    def select_node(self, observations, edge_for_select_node):
        ...
        next_node = self.env.get_opponent_position(self.env.robot_indexes, self.env.target_index)
    ...
    def run_episode(self, curr_episode):
        if self.env.input_type == 'map':
            ...
            for i in range(128):
                ...
                final_all_observations, edge_for_select_node = self.get_observations()
                self.save_next_observations(final_all_observations)
