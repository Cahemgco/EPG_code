...
def main():
    ...
    entropy_target = 0.1 * (-np.log(1 / K_SIZE))
        ...
        while True:
            ...
            if curr_episode % 1 == 0 and len(experience_buffer[0]) >= MINIMUM_BUFFER_SIZE:
                ...
                for j in range(8):
                    ...
                    policy_loss = 0
                    logp = dp_policy(node_inputs_batch, all_edge_inputs_batch, all_current_inputs_batch,\
                                       node_padding_mask_batch, all_edge_padding_mask_batch, edge_mask_batch)                    
                    ...
                    with torch.no_grad():
                        ...
                        next_logp = dp_policy(next_node_inputs_batch, next_all_edge_inputs_batch, next_all_current_inputs_batch,\
                                               node_padding_mask_batch, next_all_edge_padding_mask_batch, edge_mask_batch)
