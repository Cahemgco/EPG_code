...
This repository contains an implementation of Equilibrium Policy Generalization (EPG) proposed in our paper [1] at NeurIPS 2025. Four no-exit scenarios (2vs1-pursuer, 2vs1-evader, 6vs1-pursuer, and 6vs1-evader) and one multi-exit scenario (5vs1-pursuer) are considered in our implementation. If you have any questions, please contact lurunyu17@mails.ucas.ac.cn.
